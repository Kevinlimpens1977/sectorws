...
CREATE POLICY "Enable delete for unbooked slots"
    ON slots FOR DELETE
...
CREATE OR REPLACE FUNCTION book_slot(
    ...
    p_student_topic TEXT
) RETURNS BOOLEAN AS $$
BEGIN
    -- Insert or update student
    INSERT INTO students (student_number, name, class, topic)
    VALUES (p_student_number, p_student_name, p_student_class, p_student_topic)
